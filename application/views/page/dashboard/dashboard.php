            ...
            <div class="col-xl-4 col-6">
                <div class="card">
                    <div class="card-body p-1">
                        <div class="row">
                            <div class="col-3 box">
                                <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-lg icon-lg mt-3">
                                    <i type="button" class="ni ni-building fa-beat text-lg opacity-10 mt-2" aria-hidden="true"></i>
                                </div>
                            </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-12 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-2">
                            <h6><a href="<?= base_url('Customer'); ?>/event/<?= $tittle; ?>"> <?= $data->nm_perum; ?> </a></h6>
                        </div>
                        <div class="card-body">
